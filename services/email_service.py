# services/email_service.py - Brevo API Version (FIXED)
import os
...
BREVO_SENDER_EMAIL = os.getenv('BREVO_SENDER_EMAIL', 'briankigame7@gmail.com')
...
def send_email(to_email, subject, html_content, text_content=None, from_name=BLOG_NAME):
    """Send email using Brevo API (NO context manager)"""
    ...
    try:
        ...
        # Create API client (NOT using 'with')
...
def send_verification_email(email, token):
    """Send email verification for subscription"""
    verify_url = f"{FRONTEND_URL}/subscribe/verify/{token}"
    subject = "Confirm your subscription to RootNetwork"
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
        <style>
            ...
            .header {{ background: #07255b; color: white; padding: 20px; text-align: center; }}
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Thank you for subscribing to <strong>RootNetwork</strong>!</p>
                ...
                <p style="color: #999; font-size: 12px; margin-top: 20px;">
                    You're receiving this because you subscribed to RootNetwork updates.
                </p>
            </div>
        </div>
    </body>
...
def send_unsubscribe_confirmation(email):
    """Send confirmation when user unsubscribes"""
    subject = "You've been unsubscribed from RootNetwork"
    html_content = f"""
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="font-size:12px; color:#888;">
                    You received this because you subscribed to RootNetwork updates.
                </p>
            </div>
        </div>
    </body>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <ul>{post_list}</ul>
                <p style="text-align: center;">
                    <a href="{FRONTEND_URL}" style="color: #07255b;">Visit RootNetwork</a>
                </p>
                <hr>
                <p style="font-size:12px; color:#888;">
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p style="text-align: center;">
                    <a href="{FRONTEND_URL}/login" class="button">Login Here</a>
                </p>
                <p>After logging in, you can create and publish posts, edit your profile, and more.</p>
                <div class="footer">
